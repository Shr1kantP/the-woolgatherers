...
const curevedaProject: ProjectData = {
  logo: blob("/images/Guests/cureveda.webp"),
  title: "CUREVEDA",
  industry: "Health & Wellness",
  tags: ["Content Production", "UGC Content"],
  heroImage: blob("/images/detailed_page/cureveda/cureveda_1.jpg"),
  overview:
  ...
  gallery: [
    blob("/images/detailed_page/cureveda/cureveda_1.jpg"),  
    blob("/images/detailed_page/cureveda/cureveda_vid.mp4"),
    blob("/images/detailed_page/cureveda/cureveda_2.jpg"),
  ],
  relatedProjects: [
    {
