...
export default function Hero() {
  return (
    <section className="relative h-screen w-full bg-[#1D0121]">
      ...
      {/* Stacked frame cards */}
      <div className="absolute z-[25] left-1/2 -translate-x-1/2 top-[10%] w-[min(77vw,374px)] sm:left-[4vw] sm:translate-x-0 sm:top-[20%] sm:w-[clamp(250px,27.5vw,350px)]">
        <Image
