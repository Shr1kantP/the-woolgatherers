  ...
  return (
    <article className="font-inter max-w-4xl mx-auto px-4 pt-4 pb-12">
      ...
      <header className="mb-6 text-center flex flex-col items-center">
        <time className="text-xs font-semibold tracking-widest uppercase text-[#d6dee9]/70 mb-4 block">
          {date}
        </time>
        <h1 className="font-inter text-4xl md:text-6xl text-[#d6dee9] mb-4 leading-tight max-w-3xl">
          {title}
        </h1>
        <p className="text-xl md:text-2xl italic text-[#d6dee9]/85 font-light max-w-2xl mb-4">
          {subtitle}
        </p>
      </header>
      ...
      <div className="w-full flex items-center justify-between text-sm font-medium text-gray-500 uppercase tracking-widest mb-12">
        ...
        <button aria-label="Share this post" className="hover:text-[#d6dee9] transition-colors flex items-center" title="Share">
            ...
            case 'list':
              return (
                <div key={index} className="mb-6">
                  ...
                  <ul className="list-disc pl-6 space-y-2 marker:text-[#d6dee9]/60">
