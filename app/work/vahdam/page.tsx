...
const vahdamProject: ProjectData = {
  logo: blob("/images/Guests/vahdam-white.webp"),
  title: "VAHDAM",
  industry: "Food & Beverage",
  tags: ["Content Production", "UGC Content"],
  heroImage: blob("/images/detailed_page/Vahdam/vahdam_1.jpg"),
  overview:
  ...
  gallery: [
    blob("/images/detailed_page/Vahdam/vahdam_1.jpg"),
    blob("/images/detailed_page/Vahdam/vahdam_vid_1.mp4"),
    blob("/images/detailed_page/Vahdam/vadham_2.webp"),
    blob("/images/detailed_page/Vahdam/vahdam_vid_2.mp4"),
    blob("/images/detailed_page/Vahdam/vahdam_vid_3.mp4"),
  ],
  relatedProjects: [
    {
